...
output_path = "./twitter_data/datos_en_bruto/catched_tweets_8.csv"  # <----- Ruta de salida para el archivo, el archivo 4 es para pruebas.
number_of_tweets_for_catch = 500000  # <----- Numero de tweets en total.

def entrenar_modelos_sentiments_supervisados(modelo_entr, df_balanceado, df_lematizado):
    ...
    if modelo_entr in modelos_es and modelo_entr in modelos_en and 0 <= df_balanceado <= 1 and 0 <= df_lematizado <= 1:
        ...
        # -------- Español.
        ruta_vocabulario_es = "./vocabularios/vocabulario_sentiment_es.pkl"
        ...
        # -------- Ingles.
        ruta_vocabulario_en = "./vocabularios/vocabulario_sentiment_en.pkl"
        ...
        # -------- Español.
        ruta_modelo_es = './modelos/' + str(type(modelo_es).__name__) + '_Sentiment_es.sav'
        ...
        # -------- Ingles.
        ruta_modelo_en = './modelos/' + str(type(modelo_en).__name__) + '_Sentiment_en.sav'

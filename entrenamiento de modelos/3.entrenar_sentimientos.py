...
pickle.dump(modelo, open('./modelos/' + str(type(modelo).__name__) + '_Completo_Sentiment.sav', 'wb'))
modelo_es.fit(training_data_es, label_train_es)
pickle.dump(modelo_es, open('./modelos/' + str(type(modelo_es).__name__) + '_Español_Sentiment.sav', 'wb'))
modelo_en.fit(training_data_en, label_train_en)
pickle.dump(modelo_en, open('./modelos/' + str(type(modelo_en).__name__) + '_Ingles_Sentiment.sav', 'wb'))
